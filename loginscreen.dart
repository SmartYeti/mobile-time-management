...
import 'package:time_management/homescreen.dart';
                ...
                GestureDetector(
                  ...
                  onTap: () async{
                    ...
                    if(id.isEmpty){
                      ...
                      content: Text("Please Input Employee ID!"),
                      ));
                      ...
                      try{
                        ...
                        if(id == 'Martin10' && password == 'martin'){
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                      content: Text("Employee ID or Password is Incorrect!"),
                      ));
